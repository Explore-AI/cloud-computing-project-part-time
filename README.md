...
---
### Part I: Create and host website
---

  **Step 1:** In the first step you will create a **private** fork of this repo that stores all of the code needed to host your static website. 
...
> 👩‍🏫**Student Instruction**👩‍🏫
> 
> To successfully complete this section of the project, make use of the detailed instructions found [here](./student_instructions/Create_and_host_website.md).

---
### Part II: Create and initialise AWS resources
---
  ...
  **Step 6:** In this step things get interesting. We set up the AWS Lambda function, a Numpy ARN layer, and an AWS API Gateway trigger:
  ...
  > 👩‍🏫**Student Instruction**👩‍🏫
> 
> To successfully complete this section of the project, make use of the detailed instructions found [here](./student_instructions/Create_and_initialise_aws_resources.md).
...
---
  ...
  **Step 9:** In this final step you will be required to complete the NLP portion of the project with the use of AWS Comprehend and by defining additional program logic. At a high level, AWS Comprehend will be used to extract sentiment and key phrases from a message sent from your static website. Using programming logic, you will then define several helper methods and functions which will enable the population of an automated response if the extracted key phrases and sentiment align to specific operating conditions. 

 > 👩‍🏫**Student Instruction**👩‍🏫
> 
> To successfully complete this section of the project, make use of the detailed instructions found [here](./student_instructions/Putting_it_all_together.md).
